      ...
      <div className="container max-w-8xl mx-auto px-8 lg:px-0">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="flex flex-row justify-center items-center w-full mt-8 lg:mt-0">
            <div>
              <button className="px-8 py-3 border border-green-500 text-green-500 duration-200 hover:bg-green-500 hover:text-white hover:-translate-y-1 hover:shadow-lg mr-12">
                Retail FAQs
              </button>
              <button className="px-8 py-3 border border-green-500 text-green-500 duration-200 hover:bg-green-500 hover:text-white hover:-translate-y-1 hover:shadow-lg">
                Brand FAQs
              </button>
            </div>
          </div>
